...
for i in range (1,set_size):
    df_fold_f = pandas.read_csv(zf_fold_f.open('output_resids/red_resids'+str(i)+'.csv'))
    df_fold_r = pandas.read_csv(zf_fold_r.open('output_resids/red_resids'+str(i)+'.csv'))
    df_hopf_f = pandas.read_csv(zf_hopf_f.open('output_resids/red_resids'+str(i)+'.csv'))
    df_hopf_r = pandas.read_csv(zf_hopf_r.open('output_resids/red_resids'+str(i)+'.csv'))
    df_branch_f = pandas.read_csv(zf_branch_f.open('output_resids/red_resids'+str(i)+'.csv'))
    df_branch_r = pandas.read_csv(zf_branch_r.open('output_resids/red_resids'+str(i)+'.csv'))
...
a_name="best_model_combined_red_"
b_name = kk_num
c_name = ".pkl"
...
model_name = "best_model_combined_red_"+str(kk_num)+".pkl"
...
result_acc = open('combined_red_result.txt','a+')

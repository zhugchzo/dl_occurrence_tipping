...
for i in range (1,set_size):
    df_f = pandas.read_csv(zf_hopf_f.open('output_resids/white_resids'+str(i)+'.csv'))
    df_r = pandas.read_csv(zf_hopf_r.open('output_resids/white_resids'+str(i)+'.csv'))
...
label_f='/output_forward/ts_500/hopf/combined/values.csv'
label_r='/output_reverse/ts_500/hopf/combined/values.csv'
...
groups_f_name='/output_forward/ts_500/hopf/combined/groups.csv'
#groups_r_name='/output_reverse/ts_500/hopf/combined/groups.csv'
...
model_name = "best_model_hopf_white_"+str(kk_num)+".pkl"
...
result_acc = open('hopf_white_result.txt','a+')

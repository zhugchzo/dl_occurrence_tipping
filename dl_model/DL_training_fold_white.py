...
label_f='/output_forward/ts_500/fold/combined/values.csv'
label_r='/output_reverse/ts_500/fold/combined/values.csv'
...
model_name = "best_model_fold_white_"+str(kk_num)+".pkl"
...
result_acc = open('fold_white_result.txt','a+')

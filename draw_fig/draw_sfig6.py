...
df = pandas.read_csv('../results/may_fold/may_fold_crate_nus.csv')
...
df = pandas.read_csv('../results/food_hopf/food_hopf_crate_nus.csv')
...
df = pandas.read_csv('../results/cr_branch/cr_branch_crate_nus.csv')
...
df = pandas.read_csv('../results/global_fold/global_fold_crate_nus.csv')
...
df = pandas.read_csv('../results/MPT_hopf/MPT_hopf_crate_nus.csv')
...
df = pandas.read_csv('../results/amazon_branch/amazon_branch_crate_nus.csv')
...
plt.tight_layout()
plt.savefig('../figures/SFIG6.pdf',format='pdf',dpi=600)

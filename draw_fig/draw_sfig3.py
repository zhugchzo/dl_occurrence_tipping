...
df = pandas.read_csv('../results/may_fold/may_fold_bh_us.csv')
...
df = pandas.read_csv('../results/food_hopf/food_hopf_kh_us.csv')
...
df = pandas.read_csv('../results/cr_branch/cr_branch_ah_us.csv')
...
plt.xticks(xtick,fontproperties=font_x)
plt.ylim(-0.4,8.4)
plt.yticks([0,4,8],fontproperties=font_y)
plt.gca().invert_xaxis()
ax = plt.gca()
...
df = pandas.read_csv('../results/global_fold/global_fold_uh_us.csv')
...
df = pandas.read_csv('../results/MPT_hopf/MPT_hopf_uh_us.csv')
...
df = pandas.read_csv('../results/amazon_branch/amazon_branch_ph_us.csv')
...
plt.savefig('../figures/SFIG3.pdf',format='pdf',dpi=600)

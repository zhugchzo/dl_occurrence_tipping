...
sample_start = [0,500,1000,5000,5500,6000,6500]
...
for ss in sample_start:
    ...
    df_resids = pandas.read_csv('../data_nus/microcosm_fold/{}/microcosm_fold_resids.csv'.format(ss))
    ...
    df_ac = pandas.read_csv('../data_nus/microcosm_fold/{}/microcosm_fold_ac.csv'.format(ss))
    ...
    df_dev = pandas.read_csv('../data_nus/microcosm_fold/{}/microcosm_fold_dev.csv'.format(ss))
...
preds_results.to_csv('../../results/microcosm_fold.csv',header = True)

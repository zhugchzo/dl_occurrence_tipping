...
for p in range(len(microcosm_par_range_list)):
    ...
    for i in range(1,kk+1):
        ...
        model_name = '../../dl_null_model/best_model_fold_white_null_{}.pkl'.format(i)
...
for p in range(len(thermoacoustic_par_range_list)):
    ...
    for i in range(1,kk+1):
        ...
        model_name = '../../dl_null_model/best_model_hopf_white_null_{}.pkl'.format(i)
...
for p in range(len(Mo_par_range_list)):
    ...
    for i in range(1,kk+1):
        ...
        model_name = '../../dl_null_model/best_model_fold_red_null_{}.pkl'.format(i)
...
for p in range(len(U_par_range_list)):
    ...
    for i in range(1,kk+1):
        ...
        model_name = '../../dl_null_model/best_model_branch_red_null_{}.pkl'.format(i)
...
csv_out.to_csv('../../results/empirical_nus_results_null.csv',header = True)
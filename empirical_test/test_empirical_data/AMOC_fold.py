...
for ss in sample_start:
    ...
    df_resids = pandas.read_csv('../data_nus/AMOC_fold/{}/AMOC_fold_resids.csv'.format(ss))
    ...
    for i in range(1,kk+1):
        ...
        test_preds = model.predict(test, verbose=0)
    ...
    df_ac = pandas.read_csv('../data_nus/AMOC_fold/{}/AMOC_fold_ac.csv'.format(ss))
    ...
    df_dev = pandas.read_csv('../data_nus/AMOC_fold/{}/AMOC_fold_dev.csv'.format(ss))
...
preds_results.to_csv('../../results/AMOC_fold.csv',header = True)

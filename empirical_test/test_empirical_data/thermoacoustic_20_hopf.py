...
for ss in sample_start:
    ...
    df_resids = pandas.read_csv('../data_nus/thermoacoustic_20_hopf/{}/thermoacoustic_20_hopf_resids.csv'.format(ss))
    ...
    df_ac = pandas.read_csv('../data_nus/thermoacoustic_20_hopf/{}/thermoacoustic_20_hopf_ac.csv'.format(ss))
    ...
    df_dev = pandas.read_csv('../data_nus/thermoacoustic_20_hopf/{}/thermoacoustic_20_hopf_dev.csv'.format(ss))
...
preds_results.to_csv('../../results/thermoacoustic_20_hopf.csv',header = True)

...
for i in np.arange(numSims)+1:
    ...
    filepath_resids='../data_nus/thermoacoustic_hopf/thermoacoustic_40_hopf/thermoacoustic_40_hopf_400_resids_{}.csv'.format(par_range_sum[i-1])
    ...
    filepath_state='../data_nus/thermoacoustic_hopf/thermoacoustic_40_hopf/thermoacoustic_40_hopf_400_state_{}.csv'.format(par_range_sum[i-1])
    df_state.to_csv(filepath_state,index=False)

    filepath_interpolate='../data_nus/thermoacoustic_hopf/thermoacoustic_40_hopf/thermoacoustic_40_hopf_400_interpolate_{}.csv'.format(par_range_sum[i-1])

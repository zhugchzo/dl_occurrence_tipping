...
# dataset[0:int(4E5/(2.4/1.87))]  0-1.87 (the tipping point)

sample_start = [0, 0.2, 0.4, 0.6, 0.8, 1, 1.2, 1.4, 1.6, 1.8]

for ss in sample_start:

    if not os.path.exists('../data_nus/thermoacoustic_60_hopf/{}'.format(ss)):
        os.makedirs('../data_nus/thermoacoustic_60_hopf/{}'.format(ss))

    if ss == 0:

        dataset_s = np.array(dataset[ss : int(4E5/(2.4/1.87))])

    else:

        dataset_s = np.array(dataset[int(4E5/(2.4/ss)) : int(4E5/(2.4/1.87))])
    ...
    filepath_resids='../data_nus/thermoacoustic_60_hopf/{}/thermoacoustic_60_hopf_resids.csv'.format(ss)
    ...
    filepath_interpolate='../data_nus/thermoacoustic_60_hopf/{}/thermoacoustic_60_hopf_interpolate.csv'.format(ss)
    ...
    filepath_ac = '../data_nus/thermoacoustic_60_hopf/{}/thermoacoustic_60_hopf_ac.csv'.format(ss)
    ...
    filepath_dev = '../data_nus/thermoacoustic_60_hopf/{}/thermoacoustic_60_hopf_dev.csv'.format(ss)

...
for c in range(numSims):
    ...
    interpolated_df = pd.read_csv('../data_nus/thermoacoustic_hopf/thermoacoustic_60_hopf/thermoacoustic_60_hopf_400_interpolate_{}.csv'.format(par_range_sum[c]))
    ...
    filepath_dev = '../data_nus/thermoacoustic_hopf/thermoacoustic_60_hopf/thermoacoustic_60_hopf_400_dev_{}.csv'.format(par_range_sum[c])
    ...
    filepath_ac='../data_nus/thermoacoustic_hopf/thermoacoustic_60_hopf/thermoacoustic_60_hopf_400_ac_{}.csv'.format(par_range_sum[c])

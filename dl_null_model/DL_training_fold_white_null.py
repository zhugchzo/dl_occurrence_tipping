...
zf_fold_f = zipfile.ZipFile('/ouput_forward/ts_500/fold/combined/output_resids.zip')
zf_fold_r = zipfile.ZipFile('/ouput_reverse/ts_500/fold/combined/output_resids.zip')
sequences = list()
normalization = list()

#fold
for i in range (1,set_size):
    df_f = pandas.read_csv(zf_fold_f.open('output_resids/white_resids'+str(i)+'.csv'))
    df_r = pandas.read_csv(zf_fold_r.open('output_resids/white_resids'+str(i)+'.csv'))
...
label_f='/ouput_forward/ts_500/fold/combined/values.csv'
label_r='/ouput_reverse/ts_500/fold/combined/values.csv'
...
groups_f_name='/ouput_forward/ts_500/fold/combined/groups.csv'
#groups_r_name='/ouput_reverse/ts_500/fold/combined/groups.csv'
...
a_name="best_model_fold_white_null_"
b_name = kk_num
c_name = ".pkl"
...
model_name = "best_model_fold_white_null_"+str(kk_num)+".pkl"
...
result_acc = open('fold_white_null_result.txt','a+')

...
zf_branch_f = zipfile.ZipFile('/ouput_forward/ts_500/branch/combined/output_resids.zip')
zf_branch_r = zipfile.ZipFile('/ouput_reverse/ts_500/branch/combined/output_resids.zip')
sequences = list()
normalization = list()

#branch
for i in range (1,set_size):
    df_f = pandas.read_csv(zf_branch_f.open('output_resids/red_resids'+str(i)+'.csv'))
    df_r = pandas.read_csv(zf_branch_r.open('output_resids/red_resids'+str(i)+'.csv'))
...
label_r='/ouput_reverse/ts_500/branch/combined/values.csv'
...
groups_f_name='/ouput_forward/ts_500/branch/combined/groups.csv'
#groups_r_name='/ouput_reverse/ts_500/branch/combined/groups.csv'
...
a_name="best_model_branch_red_null_"
b_name = kk_num
c_name = ".pkl"
...
model_name = "best_model_branch_red_null_"+str(kk_num)+".pkl"
...
result_acc = open('branch_red_null_result.txt','a+')

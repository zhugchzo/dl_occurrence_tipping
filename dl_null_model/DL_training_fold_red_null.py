...
for i in range (1,set_size):
    df_f = pandas.read_csv(zf_fold_f.open('output_resids/red_resids'+str(i)+'.csv'))
    df_r = pandas.read_csv(zf_fold_r.open('output_resids/red_resids'+str(i)+'.csv'))
...
a_name="best_model_fold_red_null_"
b_name = kk_num
c_name = ".pkl"
...
model_name = "best_model_fold_red_null_"+str(kk_num)+".pkl"
...
result_acc = open('fold_red_null_result.txt','a+')

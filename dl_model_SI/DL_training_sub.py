...
zf_sub_pitchfork = zipfile.ZipFile('/pitchfork/output/sub_pitchfork/combined/output_sims.zip')
...
label_sub_pitchfork='/pitchfork/output/sub_pitchfork/combined/values.csv'
...
groups_name='/pitchfork/output/sub_pitchfork/combined/groups.csv'

...
for i in range(single_train_numbers):
    ...
    targets_hopf_f_white_value = (targets_hopf_f_value - normalization[4*i][0])/normalization[4*i][1]
    targets_hopf_f_red_value = (targets_hopf_f_value - normalization[4*i+1][0])/normalization[4*i+1][1]
    targets_hopf_r_white_value = (targets_hopf_r_value - normalization[4*i+2][0])/normalization[4*i+2][1]
    targets_hopf_r_red_value = (targets_hopf_r_value - normalization[4*i+3][0])/normalization[4*i+3][1]
...
groups_name='/increased_bifurcation/output/ts_500/hopf/combined/groups.csv'
...
model_name = "best_model_hopf_"+str(kk_num)+".keras"

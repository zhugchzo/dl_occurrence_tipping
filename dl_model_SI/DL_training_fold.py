...
for i in range(single_train_numbers):
    ...
    targets_fold_f_white_value = (targets_fold_f_value - normalization[4*i][0])/normalization[4*i][1]
    targets_fold_f_red_value = (targets_fold_f_value - normalization[4*i+1][0])/normalization[4*i+1][1]
    targets_fold_r_white_value = (targets_fold_r_value - normalization[4*i+2][0])/normalization[4*i+2][1]
    targets_fold_r_red_value = (targets_fold_r_value - normalization[4*i+3][0])/normalization[4*i+3][1]
...
model_name = "best_model_fold_"+str(kk_num)+".keras"

...
#hopf
for i in batch_nums:
    filepath = 'output_forward/ts_{}/batch{}/hopf/output_values/out_values.csv'.format(ts_len,i)
...
# Export
filepath='output_forward/ts_{}/hopf/combined/'.format(ts_len)
if not os.path.exists('output_forward/ts_{}/hopf/'.format(ts_len)):
    os.mkdir('output_forward/ts_{}/hopf/'.format(ts_len))
...
#fold
for i in batch_nums:
    filepath = 'output_forward/ts_{}/batch{}/fold/output_values/out_values.csv'.format(ts_len,i)
    df_values = pd.read_csv(filepath)
...
# Export
filepath='output_forward/ts_{}/fold/combined/'.format(ts_len)
if not os.path.exists('output_forward/ts_{}/fold/'.format(ts_len)):
    os.mkdir('output_forward/ts_{}/fold/'.format(ts_len))
if not os.path.exists(filepath):
    os.mkdir(filepath)
...
#branch
for i in batch_nums:
    filepath = 'output_forward/ts_{}/batch{}/branch/output_values/out_values.csv'.format(ts_len,i)
    df_values = pd.read_csv(filepath)
...
# Export
filepath='output_forward/ts_{}/branch/combined/'.format(ts_len)
if not os.path.exists('output_forward/ts_{}/branch/'.format(ts_len)):
    os.mkdir('output_forward/ts_{}/branch/'.format(ts_len))
if not os.path.exists(filepath):
    os.mkdir(filepath)
...
#hopf
for i in batch_nums:
    filepath = 'output_forward/ts_{}/batch{}/hopf/output_groups/groups.csv'.format(ts_len,i)
...
#fold
for i in batch_nums:
    filepath = 'output_forward/ts_{}/batch{}/fold/output_groups/groups.csv'.format(ts_len,i)
    df_groups_temp = pd.read_csv(filepath)
...
#branch
for i in batch_nums:
    filepath = 'output_forward/ts_{}/batch{}/branch/output_groups/groups.csv'.format(ts_len,i)
    df_groups_temp = pd.read_csv(filepath)

...
if not os.path.exists('../../results/saliency/may_fold'):
    os.makedirs('../../results/saliency/may_fold')
...
for c_rate in [1e-5,2e-5,3e-5,4e-5,5e-5]:
    ...
    for n in range(1,numtest+1):
        ...
        csv_saliency_out.to_csv('../../results/saliency/may_fold/saliency_feature_{}_{}.csv'.format(c_rate,n),header = True)
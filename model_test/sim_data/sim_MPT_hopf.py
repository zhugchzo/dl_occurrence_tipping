...
for i in np.linspace(0,0.3,11):
    ...
    for c_rate in [1e-5,2e-5,3e-5,4e-5,5e-5]:
        ...
        if not os.path.exists('../data_nus/MPT_hopf_red/{}/{}/temp'.format(ul,c_rate)):
            os.makedirs('../data_nus/MPT_hopf_red/{}/{}/temp'.format(ul,c_rate))

        if not os.path.exists('../data_us/MPT_hopf_red/{}/{}/temp'.format(ul,c_rate)):
            os.makedirs('../data_us/MPT_hopf_red/{}/{}/temp'.format(ul,c_rate))

        # Filter time-series
        df_traj_1.to_csv('../data_nus/MPT_hopf_red/{}/{}/temp/df_traj.csv'.format(ul,c_rate))
        df_traj_2.to_csv('../data_us/MPT_hopf_red/{}/{}/temp/df_traj.csv'.format(ul,c_rate))

        if not os.path.exists('../data_nus/MPT_hopf_red/{}/{}/dev'.format(ul,c_rate)):
            os.makedirs('../data_nus/MPT_hopf_red/{}/{}/dev'.format(ul,c_rate))

        if not os.path.exists('../data_us/MPT_hopf_red/{}/{}/dev'.format(ul,c_rate)):
            os.makedirs('../data_us/MPT_hopf_red/{}/{}/dev'.format(ul,c_rate))
        ...
        for i in range(numSims):
            ...
            filepath_dev = '../data_nus/MPT_hopf_red/{}/{}/dev/MPT_hopf_dev_{}.csv'.format(ul,c_rate,i+1)
        ...
        for i in range(numSims):
            ...
            df_dev['u'] = dev_u
            # Export DEV as individual files for dynamical eigenvalue
            filepath_dev = '../data_us/MPT_hopf_red/{}/{}/dev/MPT_hopf_dev_{}.csv'.format(ul,c_rate,i+1)
            df_dev.to_csv(filepath_dev,index=False)

            print('DEV for realisation '+str(i+1)+' complete')

        # Create directories for output
        if not os.path.exists('../data_nus/MPT_hopf_red/{}/{}/ac'.format(ul,c_rate)):
            os.makedirs('../data_nus/MPT_hopf_red/{}/{}/ac'.format(ul,c_rate))

        if not os.path.exists('../data_us/MPT_hopf_red/{}/{}/ac'.format(ul,c_rate)):
            os.makedirs('../data_us/MPT_hopf_red/{}/{}/ac'.format(ul,c_rate))
        ...
        for i in range(numSims):
            ...
            filepath_ac = '../data_nus/MPT_hopf_red/{}/{}/ac/MPT_hopf_ac_{}.csv'.format(ul,c_rate,i+1)
        ...
        for i in range(numSims):
            ...
            df_ac['u'] = u_ac
            # Export lag-1 autocorrelation red as individual files for BB method
            filepath_ac = '../data_us/MPT_hopf_red/{}/{}/ac/MPT_hopf_ac_{}.csv'.format(ul,c_rate,i+1)
            df_ac.to_csv(filepath_ac,index=False)
        ...
        # Create directories for output
        if not os.path.exists('../data_nus/MPT_hopf_red/{}/{}/sims'.format(ul,c_rate)):
            os.makedirs('../data_nus/MPT_hopf_red/{}/{}/sims'.format(ul,c_rate))

        if not os.path.exists('../data_us/MPT_hopf_red/{}/{}/sims'.format(ul,c_rate)):
            os.makedirs('../data_us/MPT_hopf_red/{}/{}/sims'.format(ul,c_rate))
        ...
        for i in np.arange(numSims)+1:
            ...
            filepath='../data_nus/MPT_hopf_red/{}/{}/sims/MPT_hopf_sims_{}.csv'.format(ul,c_rate,i)
            df_sims.to_csv(filepath,index=False)

        for i in np.arange(numSims)+1:
            df_sims = df_traj_2[df_traj_2['tsid'] == i][['Time','x','u']]
            filepath='../data_us/MPT_hopf_red/{}/{}/sims/MPT_hopf_sims_{}.csv'.format(ul,c_rate,i)
            df_sims.to_csv(filepath,index=False)

        df_result_1.to_csv('../data_nus/MPT_hopf_red/{}/{}/MPT_hopf_result.csv'.format(ul,c_rate))
        df_result_2.to_csv('../data_us/MPT_hopf_red/{}/{}/MPT_hopf_result.csv'.format(ul,c_rate))

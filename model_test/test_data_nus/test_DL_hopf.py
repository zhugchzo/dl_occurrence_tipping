...
for b in np.linspace(0,0.2,11):
    ...
    for c_rate in [1e-5,2e-5,3e-5,4e-5,5e-5]:
        ...
        for i in range(1,kk+1):
            ...
            model_name = '/gs/home/by2109123/dl_model_SI/best_model_hopf_{}.keras'.format(i)
...
csv_out.to_csv('/gs/home/by2109123/results/single_DL_model/test_DL_hopf.csv',header = True)
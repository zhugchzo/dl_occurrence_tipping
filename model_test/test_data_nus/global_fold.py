...
for i in np.linspace(1.4,1.2,11):
    ...
    for i in range (1,numtest+1):
        df_resids = pandas.read_csv('../data_nus/global_fold_red/{}/resids/global_fold_500_resids_'.format(ul)+str(i)+'.csv')
        df_ac = pandas.read_csv('../data_nus/global_fold_red/{}/ac/global_fold_500_ac_'.format(ul)+str(i)+'.csv')
        df_dev = pandas.read_csv('../data_nus/global_fold_red/{}/dev/global_fold_500_dev_'.format(ul)+str(i)+'.csv')
    ...
    result = pandas.read_csv('../data_nus/global_fold_red/{}/global_fold_500_result.csv'.format(ul),header=0)
...
csv_out.to_csv('../../results/global_fold_nus.csv',header = True)
...
for i in np.linspace(0,0.3,11):
    ...
    for i in range (1,numtest+1):
        ...
        df_ac = pandas.read_csv('../data_nus/MPT_hopf_red/{}/ac/MPT_hopf_500_ac_'.format(ul)+str(i)+'.csv')
        df_dev = pandas.read_csv('../data_nus/MPT_hopf_red/{}/dev/MPT_hopf_500_dev_'.format(ul)+str(i)+'.csv')

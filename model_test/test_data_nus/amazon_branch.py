...
for i in np.linspace(0.9,0.1,11):
    ...
    for i in range (1,numtest+1):
        df_resids = pandas.read_csv('../data_nus/amazon_branch_red/{}/resids/amazon_branch_500_resids_'.format(pl)+str(i)+'.csv')
        df_ac = pandas.read_csv('../data_nus/amazon_branch_red/{}/ac/amazon_branch_500_ac_'.format(pl)+str(i)+'.csv')
        df_dev = pandas.read_csv('../data_nus/amazon_branch_red/{}/dev/amazon_branch_500_dev_'.format(pl)+str(i)+'.csv')
    ...
    result = pandas.read_csv('../data_nus/amazon_branch_red/{}/amazon_branch_500_result.csv'.format(pl),header=0)
...
csv_out.to_csv('../../results/amazon_branch_nus.csv',header = True)
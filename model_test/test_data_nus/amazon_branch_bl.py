...
for p in np.linspace(0.9,0.1,11):
    ...
    for c_rate in [-1e-5,-2e-5,-3e-5,-4e-5,-5e-5]:
        ...
        for n in range (1,numtest+1):
            ...
            df_ac = pandas.read_csv('../data_nus/amazon_branch_red/{}/{}/ac/amazon_branch_ac_'.format(pl,c_rate)+str(n)+'.csv')
            df_dev = pandas.read_csv('../data_nus/amazon_branch_red/{}/{}/dev/amazon_branch_dev_'.format(pl,c_rate)+str(n)+'.csv')
...
csv_pl_out.to_csv('../../results/amazon_branch/amazon_branch_pl_nus.csv',header = True)
...
csv_ph_out.to_csv('../../results/amazon_branch/amazon_branch_ph_nus.csv',header = True)
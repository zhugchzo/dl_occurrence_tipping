...
for u in np.linspace(1.4,1.2,11):
    ...
    for c_rate in [-5e-7,-6e-7,-7e-7,-8e-7,-9e-7]:
        ...
        for n in range (1,numtest+1):
            df_resids = pandas.read_csv('../data_us/global_fold_red/{}/{}/resids/global_fold_resids_'.format(ul,c_rate)+str(n)+'.csv')
            df_ac = pandas.read_csv('../data_us/global_fold_red/{}/{}/ac/global_fold_ac_'.format(ul,c_rate)+str(n)+'.csv')
            df_dev = pandas.read_csv('../data_us/global_fold_red/{}/{}/dev/global_fold_dev_'.format(ul,c_rate)+str(n)+'.csv')
        ...
        result = pandas.read_csv('../data_us/global_fold_red/{}/{}/global_fold_result.csv'.format(ul,c_rate),header=0)
...
csv_ul_out.to_csv('../../results/global_fold/global_fold_ul_us.csv',header = True)
...
csv_uh_out.to_csv('../../results/global_fold/global_fold_uh_us.csv',header = True)
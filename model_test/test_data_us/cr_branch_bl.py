...
for a in np.linspace(0,5,11):
    ...
    for c_rate in [1e-4,2e-4,3e-4,4e-4,5e-4]:
        ...
        for n in range (1,numtest+1):
            df_resids = pandas.read_csv('../data_us/cr_branch_white/{}/{}/resids/cr_branch_resids_'.format(al,c_rate)+str(n)+'.csv')
            df_ac = pandas.read_csv('../data_us/cr_branch_white/{}/{}/ac/cr_branch_ac_'.format(al,c_rate)+str(n)+'.csv')
            df_dev = pandas.read_csv('../data_us/cr_branch_white/{}/{}/dev/cr_branch_dev_'.format(al,c_rate)+str(n)+'.csv')
...
csv_al_out.to_csv('../../results/cr_branch/cr_branch_al_us.csv',header = True)
...
csv_ah_out.to_csv('../../results/cr_branch/cr_branch_ah_us.csv',header = True)
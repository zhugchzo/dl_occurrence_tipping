...
for i in np.linspace(0,0.2,11):
    ...
    for i in range (1,numtest+1):
        df_resids = pandas.read_csv('../data_us/may_fold_white/{}/resids/may_fold_500_resids_'.format(bl)+str(i)+'.csv')
        df_ac = pandas.read_csv('../data_us/may_fold_white/{}/ac/may_fold_500_ac_'.format(bl)+str(i)+'.csv')
        df_dev = pandas.read_csv('../data_us/may_fold_white/{}/dev/may_fold_500_dev_'.format(bl)+str(i)+'.csv')
    ...
    result = pandas.read_csv('../data_us/may_fold_white/{}/may_fold_500_result.csv'.format(bl),header=0)
...
csv_out.to_csv('../../results/may_fold_us.csv',header = True)